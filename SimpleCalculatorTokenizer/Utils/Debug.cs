...
";
        ...
        public static void Log(object message, string messageTitle = "LOG") {
            ...
            Console.ResetColor();
            Console.WriteLine(string.Format(LogFormat, className, method, lineNumber, fileName));
#endif
            if (IsFileLoggerEnabled) logger.WriteLine("[" + messageTitle + "]" + " " + GetString(message) + string.Format(LogFormat, className, method, lineNumber, fileName));
        }
